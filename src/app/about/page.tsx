...
export const metadata: Metadata = {
  title: "About | Anvesh Reddy - Full Stack Developer",
  description:
    "Learn more about Settipalli Anvesh Reddy, a full stack developer specializing in scalable web applications, modern JavaScript frameworks, API engineering, and cloud integrations using Next.js, Node.js, React.js, Firebase, and Google Cloud.",
  keywords: [
    "About Anvesh Reddy",
    "About Settipalli ANvesh Reddy",
    "About Anvesh",
